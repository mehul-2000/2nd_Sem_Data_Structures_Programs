...
node* recursiveReverse(node* head){
    ...
    next = recursiveReverse(head->next);
    current = head;
...
//Driver Function
int main(){
    printf("Implementing Reversal of Linked list:\n");
    node *first,*reverse_simple,*reverse_interchange,*reverse_recursive;
    int len,choice;
    first = createNode();
    ...
    printf("Press 3 for Recursive Reversal of Linked List\n");
    ...
    while(choice!=4){
        switch(choice){
            ...
            case 3:
            {
                reverse_recursive = recursiveReverse(first);
                printf("Linked List after reversal is:");
                traverse(reverse_recursive);
                printf("\n");
                first = recursiveReverse(reverse_recursive);
                break;
            }
            case 4:{
                exit(0);
